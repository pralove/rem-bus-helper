...
async function loadWeather() {
    ...
    try {
        ...
        const response = await fetch(
            "https://api.open-meteo.com/v1/forecast?latitude=45.40&longitude=-74.04&daily=weather_code,temperature_2m_max,temperature_2m_min&timezone=America%2FToronto"
        );
